package com.egiants.assignments.spring_boot_jetty_demo;

import com.egiants.assignments.spring_boot_jetty_demo.controller.WelcomeController;
...
public class WelcomeControllerTest {
    ...
    public void main() throws Exception {
        ResultActions resultActions = mockMvc.perform(get("/"))
                ...
                .andExpect(model().attribute("message", equalTo("Manoj Kumar Yekollu")))
                .andExpect(model().attribute("tasks", is(expectedList)))
                .andExpect(content().string(containsString("Hello, Manoj Kumar")));
